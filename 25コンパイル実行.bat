...
@set OPTS=/noconfig /optimize+ /nologo /nostdlib+ /define:COM3D2 /define:COM3D25 /define:UNITY_5_6_OR_NEWER /define:UNITY_5_5_OR_NEWER
...
del *.dll
%CSC% %OPTS% /out:COM3D25.AlwaysColorChangeEx.Plugin.dll .\*.cs /recurse:.\Data\*.cs /recurse:.\Util\*.cs /recurse:.\UI\*.cs /recurse:.\Render\*.cs /recurse:.\TexAnim\*.cs
